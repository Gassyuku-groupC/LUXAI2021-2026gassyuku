...
$Arguments = @{
    ...
    ConfigName = "conv_teacher_bc_dagger_v12c_side_balance_delayed_risk_size"
    LeagueName = "auto_league_dagger_v12c_side_balance_delayed_risk_size"
    InitialAgent = "outputs\auto_league_dagger_v12_strategy_buffer\learner_agent"
