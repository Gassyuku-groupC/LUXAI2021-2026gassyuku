...
$Arguments = @{
    ...
    ConfigName = "conv_teacher_bc_dagger_v14b_scale_loss_stable"
    LeagueName = "auto_league_scale_loss_v14b_from_stage48"
    InitialAgent = "outputs\auto_league_scale_loss_v14\learner_agent"
