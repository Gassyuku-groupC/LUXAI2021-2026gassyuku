...
$InitialAgent = "outputs\runtime_scorer_gate_v2_from_best\agent"
$ProjectRoot = Split-Path -Parent $PSScriptRoot
if (-not (Test-Path -LiteralPath (Join-Path $ProjectRoot $InitialAgent))) {
...
$Arguments = @{
    ...
    ConfigName = "conv_learned_intervention_gate_v21"
    LeagueName = "auto_league_learned_gate_v21_from_best"
